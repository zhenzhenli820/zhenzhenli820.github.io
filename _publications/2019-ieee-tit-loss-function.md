---
title: "Toward the Optimal Construction of a Loss Function Without Spurious Local Minima for Solving Quadratic Equations"
collection: publications
permalink: /publications/2019-ieee-tit-loss-function
excerpt: 'Establishes that a new loss function for solving systems of quadratic equations (phase retrieval) has no spurious local minima under a Gaussian measurement model, with negative directional curvature around all saddle points — providing a theoretical foundation for simple first-order optimization methods on this class of nonconvex problems.'
date: 2019-01-01
